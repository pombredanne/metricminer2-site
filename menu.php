        <ul>
            ...
            <li><a href="documentation.php#threads">Dealing with Threads</a></li>
            <li><a href="documentation.php#datajoy">Using DataJoy</a></li>
            <li><a href="documentation.php#advanced">Advanced Configurations</a></li>
        </ul>